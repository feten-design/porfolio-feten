      ...
      <div className="container">
        ...
        <div className="row skills-content">
          ...
          <div className="col-lg-6">
            ...
            <div className="progress">
              <span className="skill">Express <i className="val">60%</i></span>
              <div className="progress-bar-wrap">
            ...
            <div className="progress">
              <span className="skill">REACT <i className="val">35%</i></span>
              <div className="progress-bar-wrap">
          ...
          <div className="col-lg-6">
            ...
            {/* <div className="progress">
             ...
             <div className="progress">
              <span className="skill">SPRINGBOOT <i className="val">40%</i></span>
              <div className="progress-bar-wrap">
                <div className="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style={{ width: '90%' }}></div>
              </div>
            </div>
            ...
            <div className="progress">
              <span className="skill">GOLANG <i className="val">75%</i></span>
              <div className="progress-bar-wrap">
